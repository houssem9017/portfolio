      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold mb-2">
            Other <span className="text-[#6366f1]">Projects</span>
          </h2>
          <div className="w-20 h-1 bg-[#6366f1] rounded-full mb-4" />
          <p className="text-[#9ca3af] mb-12 max-w-2xl">
            A collection of projects from internships, hackathons, and academic
            work that showcase my development journey.
          </p>
        </motion.div>
